...
class CustomTextField extends StatelessWidget {
  ...
  const CustomTextField({
    ...
    this.cursorColor = backgroundWhite,
  ...
  Widget _buildTextField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        hintText: hintText,
        labelText: labelText,
        hintStyle: TextStyle(fontSize: 14, color: isError ? Colors.red : textGrey),
        labelStyle: TextStyle(fontSize: 14, color: isError ? Colors.red : textGrey),
        floatingLabelStyle: const TextStyle(fontSize: 12, color: textGrey),
        errorText: errorText,
